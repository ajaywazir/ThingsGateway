...
public class SysResourceSeedData : ISqlSugarEntitySeedData<SysResource>
{
    ...
    {
        var data1 = SeedDataUtil.GetSeedData<SysResource>(PathExtensions.CombinePathWithOs("SeedData", "Upgrade", "seed_upgrade_resource.json"));
