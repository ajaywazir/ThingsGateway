...
/// 调试UI
/// </summary>
public abstract class DeviceComponentBase : ComponentBase, IDisposable
{
    /// <inheritdoc/>
    ~DeviceComponentBase()
    {
    ...
    {
        RegisterAddress = DefaultAddress;
    ...
    [Inject]
    private IStringLocalizer<DeviceComponentBase> Localizer { get; set; }
